...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::get('changepassword', 'Auth\PasswordController@changepwdindex');
	Route::post('changepassword', array('uses' => 'Auth\PasswordController@changePassword','as' => 'changePassword'));
