				...
				<div class="panel-body">
					...
					<form id="newevent" action="{{ URL::route('editingEvent') }}" method="post" enctype="multipart/form-data">
						...
						<div id="fee" class="form-group" style="float:left; width: 49%;">
							...
							</div> <div class="col-md-9 col-sm-9 col-xs-9" style="padding: 0"><input type="text" name="number" class="form-control" placeholder="Event Fee" <?php if ($event->fee !== 'Free') echo "value='".$event->fee."'";?>></div>
						</div>
						<!-- <div class="form-group">
