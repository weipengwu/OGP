...
<div class="container">
	<div class="row">
		<div class="fixedarea">
			<div class="panel">
				<div class="panel-heading"><h3>{{ trans('events.createanewevent') }}</h3></div>
				...
				<div class="panel-body">
					...
					<form id="newevent" action="{{ URL::route('createEvent') }}" method="post" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<span class="radio"><input type="radio" name="type" id="typepublic" value="public" checked/><label for="typepublic">{{ trans('events.publictype') }}</label> </span>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6">
							<span class="radio"><input type="radio" name="type" id="typeprivate" value="private" /> <label for="typeprivate">{{ trans('events.privatetype') }}</label></span>
							</div>
						</div>	
						<div class="form-group">
			            ...
			            <div class="form-group" style="float:left; margin-right: 2%; width: 49%;">
							...
							<select name="selectprice" id="selectprice" class="form-control">
								...
								<option value="Paid">{{ trans('events.paid') }}</option>
							</select>
							</div>
						</div>
						...
						<div class="form-group">
							<input type="text" name="suitenum" class="form-control" placeholder="{{ trans('events.suiteno') }}">
						</div>
						<div class="form-group">
							<input type="text" name="address" id="address" class="form-control" placeholder="{{ trans('events.address') }}">
						...
						<div class="form-group">
							<textarea name="content" class="form-control" placeholder="{{ trans('events.eventdescription') }}" required></textarea>
						</div>
