...
@section('content')
<div class="eventbanner" style="background: url('<?php echo url()."/".$event->banner;?>') center center no-repeat; background-size: cover;)">
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyANM_gBRmfXCbtGiN768aUL1div-Dd0TU4"></script>
